...
- If the server restarts, it forgets any conversations in progress. Fine for a demo running on one machine — a real multi-server setup would need to store that separately instead.
